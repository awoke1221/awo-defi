...
export default function Navbar() {
  ...
  // const high = document.getElementById(currentURL + '-link').style.fontWeight = '700';
  // console.log('high - ', high)
  // useEffect(() => {
  //   // let highlighted = document.getElementById(currentURL + '-link')[0].style.;
  ...
  return (
    <div className="text-white">
      ...
      <nav className="relative bg-[#1012124D] text-[20px] w-full text-center">
